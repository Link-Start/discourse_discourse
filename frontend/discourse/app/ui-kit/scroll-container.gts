...
interface ScrollContainerSignature {
  Args: {
...
export default class ScrollContainer extends Component<ScrollContainerSignature> {
  ...
  <template>
    <div class={{dConcatClass "scroll-container" @wrapperClass}}>
      {{#if this.hasTopScroll}}
        {{! eslint-disable ember/template-no-pointer-down-event-binding }}
        <button
          type="button"
          aria-hidden="true"
          class={{dConcatClass "scroll-container__btn --up" @buttonClass}}
          tabindex="-1"
      ...
      {{#if this.hasLeftScroll}}
        ...
        <button
          type="button"
          aria-hidden="true"
          class={{dConcatClass "scroll-container__btn --left" @buttonClass}}
          tabindex="-1"
          {{on "mousedown" this.preventFocusGrab}}
      ...
      <div
        class={{dConcatClass "scroll-container__content" @class}}
      ...
      {{#if this.hasRightScroll}}
        ...
        <button
          type="button"
          aria-hidden="true"
          class={{dConcatClass "scroll-container__btn --right" @buttonClass}}
          tabindex="-1"
          {{on "mousedown" this.preventFocusGrab}}
      ...
      {{#if this.hasBottomScroll}}
        ...
        <button
          type="button"
          aria-hidden="true"
          class={{dConcatClass "scroll-container__btn --down" @buttonClass}}
          tabindex="-1"
          {{on "mousedown" this.preventFocusGrab}}
